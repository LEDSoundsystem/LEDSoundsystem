...
//gets array of samples...HERE IS WHERE WE WOULD SEND BACK TO IOS APP
...
-(void)updateHeartRate:(NSMutableArray *)samples {
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        if(WCsession.reachable){
            ...
            [WCsession sendMessage:applicationData replyHandler:^(NSDictionary* replyMessage) {
                NSLog(@"got message?!");
